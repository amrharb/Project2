...
function CoursesContainer() {
 ...
 let courses=details["courses"].map((course)=>
    <Card className="w-100" key={course.id} detail={course} />
) ;
  return (
    <>
      <h3 className="header">{details.header}</h3>
      <p className="descrip">{details.description}</p>
      <button className="btn"><b>Explore Python</b></button>
      <div class="courses">
        {courses}
    </div>
    </>
